...
M_{АПСК}^{ЗПСК} =
\begin{pmatrix*}
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} \\
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} \\
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} 
\end{pmatrix*}
$$
...
M_{АПСК}^{ЗПСК} =
\begin{pmatrix*}
M_{АПСК}^{ЗПСК}_{11} & M_{АПСК}^{ЗПСК}_{12} & M_{АПСК}^{ЗПСК}_{13} \\
M_{АПСК}^{ЗПСК}_{21} & M_{АПСК}^{ЗПСК}_{22} & M_{АПСК}^{ЗПСК}_{23} \\
M_{АПСК}^{ЗПСК}_{31} & M_{АПСК}^{ЗПСК}_{32} & M_{АПСК}^{ЗПСК}_{33}
\end{pmatrix*}
$$
...
M_{АПСК}^{ЗПСК} =
\begin{pmatrix*}
M_{_{11}_АПСК}^{ЗПСК} & M_{_{12}_АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} \\
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} \\
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} 
\end{pmatrix*}
$$
...
M_{АПСК}^{ЗПСК} =
\begin{pmatrix*}
{M_{11}}_{АПСК}^{ЗПСК} & {M_{12}}_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} \\
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} \\
M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК} & M_{АПСК}^{ЗПСК}_{11} 
\end{pmatrix*}
$$
